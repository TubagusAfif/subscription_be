  ...
  components: {
    ...
    schemas: {
      ...
      CreateBundleCoinOrderRequest: {
        type: 'object',
        required: ['bundle_id', 'nominal', 'payment_source'],
        properties: {
          bundle_id: {
            type: 'integer',
            example: 2,
      ...
      CreateCoinOrderRequest: {
        type: 'object',
        required: ['coin_amount', 'nominal', 'payment_source'],
        properties: {
          coin_amount: {
            type: 'integer',
            example: 500,
      ...
      CreateClinicRequest: {
        type: 'object',
        required: ['clinic_name', 'clinic_code'],
        properties: {
          clinic_name: {
            type: 'string',
            example: 'Klinik Sehat Jaya',
      ...
      DeactivateOpUserRequest: {
        ...
        properties: {
          reason: {
            type: 'string',
            enum: ['manual', 'addon_expired', 'package_expired'],
            example: 'manual',
          },
        },
      },
