...
const spec = {
  ...
  "info": {
    ...
    "version": "1.0.0",
    "description": "API Documentation for internal routes, specifically for handling requests from Domain 2 (e.g. clinic, staff management quota assignments) and requesting renewal URLs."
  },
  "servers": [
    {
      "url": "/api/v1",
  ...
  "components": {
    ...
    "schemas": {
      "SlotAssignRequest": {
        "type": "object",
        "required": ["external_subscription_id", "resource_type", "ref_id", "ref_type", "assigned_at"],
        "properties": {
  ...
  "paths": {
    "/internal/slots/assign": {
      "post": {
        ...
        "description": "Called by Domain 2 when an owner creates a new clinic, staff, or doctor. Uses transactional locking to prevent race conditions. Returns 409 if quota is exceeded.",
        "requestBody": {
          "required": true,
          "content": {
            "application/json": {
    ...
    "/internal/slots/release": {
      "post": {
        ...
        "description": "Called by Domain 2 when an owner deletes a clinic, staff, or doctor. Idempotent.",
        "requestBody": {
          "required": true,
          "content": {
            "application/json": {
    ...
    "/internal/subscriptions/by-company/{external_subscription_id}": {
      "get": {
        ...
        "description": "Returns full subscription snapshot in subscription.sync format. Domain 2 uses this for re-sync, reconciliation, or startup.",
        "parameters": [
          { "in": "path", "name": "external_subscription_id", "required": true, "schema": { "type": "string" }, "example": "sub_123456789" }
        ],
        "responses": {
    ...
    "/internal/billing/renewal-url": {
      "post": {
        ...
        "description": "Generates a one-time, short-lived checkout URL. Domain 2 calls this when a user clicks 'Perpanjang'.",
        "requestBody": {
          "required": true,
          "content": {
            "application/json": {
