...
const spec = {
  ...
  info: {
    ...
    version: '1.0.0',
    description:
      'API Documentation for Bank Mega SNAP IPG integration. Separated into Client APIs (for initiating payments and checking status) and Admin APIs (for receiving webhooks).',
  },
  servers: [
    {
        ...
        properties: {
          ...
          urls: {
            ...
            properties: {
              selections: {
                type: 'string',
                example: 'https://pgcheckoutdev.bankmega.com/l2024E07v02v082635Y166',
              },
              checkout: {
                type: 'string',
                example: 'https://pgcheckoutdev.bankmega.com/l2024E07v02v082635Y166',
        ...
        parameters: [
          {
            ...
            required: true,
            schema: { type: 'string' },
            example: '2024-07-02T08:27:12+07:00',
          },
          { in: 'header', name: 'X-SIGNATURE', required: true, schema: { type: 'string' } },
          {
            ...
            required: true,
            schema: { type: 'string' },
            example: '6BPxIS7nJt1kwgN1PHA2YO',
          },
          {
            in: 'header',
            name: 'CHANNEL-ID',
          ...
          },
          {
            ...
            required: true,
            schema: { type: 'string' },
            example: '318075533589500931841630522',
          },
        ],
        requestBody: {
          required: true,
        ...
        parameters: [
          {
            ...
            required: true,
            schema: { type: 'string' },
            example: 'a60daf2b-1fd9-42ab-8235-41a264811025',
          },
          {
            in: 'header',
            name: 'X-TIMESTAMP',
